...
#'
#'A data package has a dataset of Saudi Arabian cities' division prices.
#'
#'
#' @format A data frame with more than 800 rows and 6 variables:
#' \describe{
#'  \item{Expenditure Category}{-food and beverages: it is the mean of(food, beverages).
...
#'                   }
#'  \item{city}{sixteen Saudi Arabian cities inclouded."Riyadh", "Makkah", "Jeddah", "Dammam", "Tiaf",
#'  "Medina", "Abha", "Alhofof", "Tabuk", "Buraydah", "Jazzan", "Hail", "Njran", "Baha", "Skaka", "Arar"}
#'  \item{year}{2020}
#'  \item{month}{month}
#'  \item{price}{The division price in that month of the year}
#'  \item{All Cities}{the sum of prices of all city on this month in this category}
#'  }
#'
#' @source \url{https://www.stats.gov.sa/en/394}
#'
"sprice"
